...
typedef int (*CHAT_DB_WRITE_WITH_IMAGE)( void*, std::wstring& activity, std::wstring& user, std::wstring& message, 
	std::string& icon, std::string &image, int width, int height, unsigned long int& rowid, unsigned long int& write_time );
typedef int (*CHAT_DB_WRITE_WITH_IMAGE_)( void*, const wchar_t *activity, const wchar_t *user, const wchar_t *message, 
...
CHATDB_DECLSPEC int chatDbWriteWithImage( void* db, std::wstring& activity, std::wstring& user, std::wstring &message, 
	std::string& icon, std::string& image, int width, int height, unsigned long int& rowid, unsigned long int& write_time );

CHATDB_DECLSPEC int chatDbWriteWithImage_( void* db, const wchar_t *activity, const wchar_t *user, const wchar_t *message, 
	const char* icon, const char* image, int width, int height, unsigned long int& rowid, unsigned long int& write_time ); 
