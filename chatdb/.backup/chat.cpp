...
int main( void ) {
	...
	CHAT_DB_READ_ pRead = (CHAT_DB_READ_) GetProcAddress (hDLL, "chatDbRead_"); 		// This one is for use in SP
	CHAT_DB_READ_IMAGE_ pReadImage = (CHAT_DB_READ_IMAGE_) GetProcAddress (hDLL, "chatDbReadImage_"); 		// This one is for use in SP
